...
class QuizGame:
    ...
    def run(self):
        ...
        while True:
            try:
                self.display_menu()
                choice = self.get_input("선택: ", range(1, 7))
    ...
    def play_quiz(self):
        ...
        try:
            ...
            print("\n========================================")
            print(f"🏆 결과: {count}문제 중 {score}문제 정답! ({score_percentage}점)")
    ...
    def show_history(self):
        ...
        for i, record in enumerate(self.history, 1):
            print(f"[{i}] {record['date']} - {record['total']}문제 중 {record['score']}문제 정답 "
                  f"({record['percentage']}점)")
        print("----------------------------------------")
